...
void handle_articles(std::map<std::string, string> pattern_dict){
    ...
    string article_options[] = {
        ...
        "Eliminar articulo",
        "Buscar articulo",
        "Borrar la lista de articulos",
        "Volver"
    };
    int selected_option = print_menu(article_options, sizeof(article_options) / sizeof(article_options[0]), "Menu de Articulos");
    ...
    if (string_contains(stringed_selected_option, "agregar")){
        ...
        if (MAIN_ARTICLE_LIST->head == NULL){
            success_screen("No hay articulos en la lista aun !");
        }  else {
        ...
        if (MAIN_ARTICLE_LIST->head == NULL){
            success_screen("Aun no hay articulos en la lista !");
        } else {
            if (handle_delete_articles_list()){
                success_screen("Lista de articulos eliminada con exito !");
            }
        }
    }
    return;
    ...
    if (string_contains(stringed_selected_option, "agregar")){
        ...
        if (MAIN_CLIENTS_LIST->head == NULL){
            ...
            if (handle_delete_clients_list()){
                success_screen("Lista de clientes eliminada con exito !");
            }
        }
    }
    return;
    ...
    if (string_contains(stringed_selected_option, "agregar")){
        ...
        if (MAIN_SELLERS_LIST->head == NULL){
            ...
            if (handle_delete_sellers_list()){
                success_screen("Lista de vendedores eliminada con exito !");
            }
        }
    }
    return;
