...
string get_product_ammount(string product_code){
    ...
    while (1){
        ...
        cout  << X_SEPARATION << "Ingresa la cantidad de unidades del producto " << product_code << " que se venderan : ";
...
string invoice_generation_handling(){
    ...
    if (MAIN_SELLERS_LIST->sellers_count == 0){
        ...
        return "No hay articulos, agrega algunos a la lista para poder crear una factura";
    } else {
        ...
        while (1){
            ...
            if (string_contains(selected_article_code, "Continuar")){
                ...
                cout << "\n" << X_SEPARATION << "Ingresa la cantidad de unidades del producto " << selected_article_code << " que se venderan : ";
                getline(cin, product_ammount);
        ...
        return "Factura "+ new_invoice.id + " generada con exito !";
    }
}
